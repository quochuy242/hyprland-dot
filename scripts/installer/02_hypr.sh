...
run_command "mkdir -p /home/$SUDO_USER/.config/hypr/ && stow hypr" "Copy hyprland config (Must)" "yes" "no" 
...
run_command "cp -r ../../configs/dunst && stow dunst" "Copy dunst config" "yes" "no"
